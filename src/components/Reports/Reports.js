...
const Reports = () => {
  ...
  return (
    <div style={{ width: '80%' }} className={`col-10 ${styles.reports}`}>
        ...
        <AppBar position="static">
          <Toolbar variant="dense" className='toolbar-align'>
            ...
            <div direction="row" className={styles.toolbar_buttons} >
              <FilterListIcon onClick={() => { setOpen(!open) }} />
      ...
      {currentReport === 'Resource' && (<ResourceReport fromMonth={fromMonth} fromYear={fromYear} toMonth={toMonth} toYear={toYear} setFromMonth={setFromMonth} setToMonth={setToMonth} setToYear={setToYear} setFromYear={setFromYear} isReload={isReload} setIsReload={setIsReload} open={open} setOpen={setOpen} />)}
    </div>)
