...
import styles from './billing.grid.scss';
  ...
  return (<div style={{width:'80%'}}>
    ...
    <AppBar position="static">
      <Toolbar variant="dense">
        ...
        <Stack direction="row"  className='toolbar_buttons'>
          <Button variant="outlined" style={{color:'#1976d2',backgroundColor:'white',display:'flex'}} onClick={handleAdd}className='add_entry'>Add Entry <AddIcon/></Button>
